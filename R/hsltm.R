...
fit.xy=function(pars,xy,FUN,models=list(y=NULL,x=NULL),pm,Pi,delta=delta,
                ...
                control=list(trace=5,reltol=1e-6,maxit=200))
{
  b=tfm(pars,FUN)
...
fit.hmltm=function(xy,pars,FUN,models=list(y=NULL,x=NULL),survey.pars,hmm.pars,control.fit,control.optim)
{
# unpack things:
...
# fit model
  est=fit.xy(pars=pars,xy=xy,FUN=FUN,models=models,pm=pm,Pi=Pi,delta=delta,theta.f=theta.f,theta.b=theta.b,W=W,ymax=ymax,dy=dy,nx=nx,hessian=hessian,control=control.optim)
...
est.hmltm=function(dat,
                   ...
                   twosit=FALSE,notrunc=FALSE,W.est=NULL){
